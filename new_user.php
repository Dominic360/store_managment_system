...
if ($id) {
    ...
    $check_sql = mysqli_query($con, $check_id);
...
if (isset($_POST['submit'])) {
    ...
    if (empty($name)) {
        ...
        $insert = "INSERT INTO `users`(`id`, `name`, `emp_img`, `email`, `password`, `store`, `role`, `date`) 
        VALUES ('$id','$name','$emp_img','$email','$password','$store','$role','$added_date')";
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-xl-10">
                                        <div class=" text-xl-start mt-xl-0 mt-2">
                                            ...
                                            $emp_name               = $row['name'];
                                            $emp_email              = $row['email'];
                                            $emp_store              = $row['store_code'];

                                            ?>
                                            <form class="row g-3 px-3 pb-4" method="POST">
                                                <div class="col-md-6">
                                                    <label for="name" class="form-label">Full Name <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="name" placeholder="Full Name" name="name" value="<?php echo $emp_name ?>" readonly>
                                                </div>
                                                <div class="col-6">
                                                    <label for="email" class="form-label">Email <span class="text-danger">*</span></label>
                                                    <input type="email" class="form-control" id="email" placeholder="Email" name="email" value="<?php echo $emp_email ?>" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" id="role" placeholder="Role" name="role">
                                                        <option selected>Choose...</option>
                                                        <option>Admin</option>
                                                        <option>Staff</option>
                                                    </select>
                                                ...
                                                <div class="col-md-6">
                                                    <label for="store" class="form-label">Store Code <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="store" placeholder="Store Code" name="store" value="<?php echo $emp_store ?>" readonly>
                                                </div>
