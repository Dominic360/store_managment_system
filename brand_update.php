...
if (isset($_POST['submit'])) {
    ...
    $update = "UPDATE `brand` SET brand='$brand',added_date='$date' WHERE id = $id";
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="brand.php">Brands</a></li>
                                        ...
                                        <div class=" text-xl-start mt-xl-0 mt-2">
                                            ...
                                            <form class="row g-3 px-3 pb-4" method="POST">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="brand" placeholder="brand" name="brand" value="<?php echo $current_brand; ?>">
                                                </div>
                                                <div class="col-md-6">
