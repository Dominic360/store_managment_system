                                                    ...
                                                    <div class="modal-dialog modal-lg shadow">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form class="row g-3 px-3 pb-4" action="php-action/brand_action.php" method="POST">
                                                                    <div class="col-md-6">
                                        ...
                                        <tbody>
                                            ...
                                            if($result > 0) {
                                                ...
                                                while($row = mysqli_fetch_assoc($sql)){
                                                    ...
                                                    <td>$date</td>" .
                                                        '<td>
                                                    <button class="btn btn-primary" title="Update"><a href="brand_update.php?updateid=' . $id . '" class="text-light text-decoration-none"><i class="mdi mdi-square-edit-outline"></i></a></button>
                                                    <button class="btn btn-danger" title="Delete"><a href="php-action/brand_delete.php?deleteid=' . $id  . '" class="action-icon fs-6 text-light text-decoration-none" data-toggle="tooltip" data-placement="top" title="Delete Product"><i class="mdi mdi-delete"></i></a></button>
